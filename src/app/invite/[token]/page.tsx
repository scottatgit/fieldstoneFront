...
export default function InvitePage() {
  ...
  // If not signed in, redirect to signup with invite param
  useEffect(() => {
        ...
        >
          ...
          {!loading && error && (
            <VStack spacing={4}>
              ...
              <Button size="sm" variant="outline" colorScheme="gray" onClick={() => router.push('/login')}>
                Go to Login
              </Button>
            </VStack>
          )}
          ...
          {!loading && !error && meta && !joined && (
            <VStack align="stretch" spacing={6}>
              ...
              <Text fontSize="2xs" color="gray.600" fontFamily="mono" textAlign="center">
                By joining, you accept the role assigned above. Contact your admin to change roles.
              </Text>
            </VStack>
          )}
          ...
          {joined && (
            <VStack spacing={4}>
              ...
              <Text fontWeight="bold" color="green.300" fontFamily="mono" textAlign="center">
                Workspace joined! Redirecting...
              </Text>
