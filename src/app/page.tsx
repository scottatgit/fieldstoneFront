        ...
        <VStack spacing={8} textAlign="center">
          <Box>
            ...
            <Text
              ...
              mx="auto"
            >
              Turn your operational data into structured intelligence.
              Close tickets faster. See what's breaking before it escalates.
            </Text>
          </Box>
          ...
          {[
            {
              ...
              desc: "Signal reads your tickets and extracts structured insights — tools, friction patterns, outbreak signals — automatically.",
              label: "See how it works",
              href: "/signup",
            },
            {
              title: "Outbreak Detection",
              desc: "Spot recurring issues across clients before they escalate. Real-time pattern recognition across your full ticket stream.",
              label: "View Demo",
              href: "https://demo.signal.fieldstone.pro/pm",
            },
            {
              title: "Works for Any Team",
              desc: "MSP, software, field ops — Signal adapts to your domain. No rigid templates. Just structured operational data.",
              label: "Get Started",
              href: "/signup",
            },
          ].map((card) => (
...
export default function RootPage() {
  ...
  useEffect(() => {
    setIsSignal(window.location.hostname === 'signal.fieldstone.pro');
  }, []);

  return (
    <ChakraProvider theme={theme}>
      {isSignal ? <SignalLanding /> : <FieldstoneLanding />}
    </ChakraProvider>
  );
}
